    ...
    <section id="vault-login" style={{ background: CHARCOAL, padding: "100px 24px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", position: "relative", textAlign: "center" }}>
        <FadeUp>
          ...
          <div style={{ width: "100%", maxWidth: 480, margin: "0 auto 20px" }}>
            {/* OJAS prefix + input stacked on mobile, row on desktop */}
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, letterSpacing: "0.2em", color: GOLD, fontFamily: "monospace", fontWeight: 600 }}>
                  OJAS CLIENT ID
                </span>
              </div>
              {/* Input full width */}
          ...
          {/* Enter Vault button — full width on mobile */}
          <div style={{ width: "100%", maxWidth: 480, margin: "0 auto 32px", padding: "0 0px" }}>
            <motion.button
              onClick={handleEnter}
              whileHover={{ boxShadow: "0 0 40px rgba(212,175,55,0.45)" }}
              whileTap={{ scale: 0.97 }}
              style={{
                width: "100%",
                padding: "18px 24px",
              ...
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={OBSIDIAN} strokeWidth="2.5" strokeLinecap="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
              Enter Vault
            </motion.button>
          </div>
            ...
            <motion.div
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "stretch", width: "100%" }}>
                    <motion.button
                      ...
                      whileHover={{ boxShadow: "0 0 32px rgba(212,175,55,0.5)" }}
                      whileTap={{ scale: 0.97 }}
                      style={{ width: "100%", padding: "18px 24px", background: GOLD, color: OBSIDIAN, fontSize: "clamp(10px, 2.5vw, 12px)", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", border: "none", borderRadius: 2, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                    ...
                    <motion.button
                      ...
                      style={{ background: "none", border: "none", color: MUTED, fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", cursor: "pointer", fontFamily: "inherit", padding: "10px 16px" }}>
                      Close
                    </motion.button>
                  </div>
                </motion.div>
              ...
              {stage === "notfound" && (
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                  ...
                  <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", flexDirection: "column", alignItems: "stretch" }}>
